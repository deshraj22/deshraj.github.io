...
<div class="container col-xxl-8 px-4 py-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      <div class="col-10 col-sm-8 col-lg-6">
        <h6 class="display-5 fw-bold lh-1 mb-5 text-center" style="color:#574b90;font-size: 35px;margin-left: 38%;">Login To Continue</h6>
        <div class="container p-5 card" style="background-color:#778beb; margin-left: 35%;">
            <form action="/userlogin2" method="post">
              @csrf
                ...
                <button type="submit" class="bn632-hover bn23 mt-5" style="margin-left: 38%;">Login</button>
              </form>
        </div>
      </div>
      <div class="col-lg-6">
        <img src="{{asset('images/login.jpg')}}" class="d-block mx-lg-auto img-fluid" alt="" width="700" height="500" loading="lazy">
        </div>
      </div>
    </div>
  </div>

        ...
        <div class="list-group list-group-flush mx-3 mt-4">
          ...
          <span id="manageproducts_sub">
            <a href="/addproduct" class="list-group-item list-group-item-action py-2 ripple active" style="background-color:#714d69;">
              ...
              <a href="#" class="list-group-item list-group-item-action py-2 ripple active"  style="background-color:#714d69;">
                <i class="fa fa-pencil fa-fw me-3"></i><span>Edit Products</span>
              </a>
              <a href="#" class="list-group-item list-group-item-action py-2 ripple active"  style="background-color:#714d69;">
                <i class="fa fa-eye fa-fw me-3"></i><span>Hide Products</span>
              </a>
              <a href="#" class="list-group-item list-group-item-action py-2 ripple active"  style="background-color:#714d69;">
                <i class="fa fa-trash fa-fw me-3"></i><span>Delete Products</span>
              </a>
          </span>
